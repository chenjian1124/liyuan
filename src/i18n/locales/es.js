export default {
  ...
  // customer
  customer_title1: "Gozamos de ",
  customer_title2: "La Confianza",
  customer_title3: "De Nuestros Clientes.",
  more: 'Ver detalles',
  // service
  ...
  // business
  business_title: "Cobertura de servicios",
  business_desc: "Operamos a nivel global y ofrecemos servicios integrales.",
  business_title1: "Credenciales del Grupo Liyuan Hengtong",
  business_desc_1: "Agente de transporte de carga de primer nivel aprobado por el Ministerio de Comercio Exterior y Cooperación Económica de China.",
  business_desc_2: "Operador de Transporte sin Buque (NVOCC) registrado ante el Ministerio de Transporte de China (NVOCC-NV00824).",
  business_desc_3: "Empresa registrada ante la Comisión Marítima Federal de los Estados Unidos (FMC).",
  business_desc_4: "Miembro de WCA Inter Global y WCA Projects (N.º 70521).",
  business_desc_5: "Certificado conforme al sistema de gestión de calidad ISO 9001 y al sistema de gestión ambiental ISO 14001.",
  business_desc_6: "Certificación del sistema de gestión de seguridad y salud en el trabajo ISO 45001.",
  ...
  bi_unit: "Votos",
  bi_desc_1: "Ranking de votos operativos Comparación intermensual",
  bi_desc_2: "Ranking de votos operativos Comparación intermensual",
  bi_desc_3: "Ranking de votos operativos Comparación intermensual",
  bi_desc_4: "Ranking de votos operativos Comparación intermensual",
  ...
  global_network_desc: 'Premiado en varias ocasiones en la industria, estableciendo una red de servicios global y asociándose estratégicamente con varias de las principales compañías navieras para proporcionar soluciones logísticas eficientes y confiables, ganando un amplio reconocimiento de los clientes. Últimas ',
  global_network_desc_1: 'gentes colaboradores a nivel global',
  global_network_desc_2: 'Red de agentes en América Latina',
  global_network_desc_3: 'Puertos clave a nivel mundial',
  global_network_desc_4: 'Número de empleados a nivel mundial',

  news_title: 'Últimas noticias',
  news_title_1: 'El proyecto de transporte sobredimensionado (OOG) de INNOVATION  desde Shanghái hasta Bielorrusia, ha iniciado con éxito.',
  news_title_2: 'Solución logística de transporte BBK de INNOVATION.',
