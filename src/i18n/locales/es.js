export default {
  ...
  header: {
    ...
    submenu: {
      internationalShipping: "Transporte marítimo internacional",
      projectLogistics: "Logística de proyectos",
      landTransportationServices: "Servicios de transporte terrestre",
      customsClearanceServices: "Servicios de despacho aduanero",
      warehousingServices: "Servicios de almacenamiento",
      internationalAirFreight: "Transporte aéreo internacional",
      solutions_1: "Logística de proyectos OOG",
      solutions_2: "Servicio de carga general",
      solutions_3: "Logística de productos químicos",
      solutions_4: "Logística automotriz",
      solutions_5: "Sabiduría logística",
      solutions_6: "Asesor profesional",
      solutions_7: "Mensaje en línea",
      about_1: "Descripción general de Liyuan",
      about_2: "Historia de desarrollo de la empresa",
      about_3: "Nuestros servicios",
      about_4: "Información de contacto",
      about_5: "Mensaje en línea",
    },
    btn: {
      schedule: "Tarifas y horarios",
    },
  },
  home: {
    title: "Inicio",
    desc: "Esta es una página de inicio de ejemplo.",
  },
  hello: {
    countIs: "El contador es {count}",
    editTip: "Edita {file} para probar HMR",
    readDocs: "Haz clic en los logos de Vite y Vue para saber más",
    links: {
      starter: "create-vue (starter oficial de Vue + Vite)",
      ide: "Documentación de Vue: herramientas y soporte IDE",
    },
  },
  // customer
  ...
  work_2:'Logística de proyectos',
  work_2_desc:'Entregar equipos y materiales de proyectos al sitio de manera segura y a tiempo, asegurando el progreso fluido del proyecto.',
  work_3:'Servicios de transporte terrestre',
  work_3_desc:'Amplia cobertura, segura y eficiente, proporcionando soluciones logísticas terrestres integrales.',
  work_4:'Servicios de despacho aduanero',
  work_4_desc:'Equipo profesional, rápido y eficiente, asegurando un despacho aduanero sin problemas de las mercancías para una llegada sin preocupaciones.',
  work_5:'Servicios de almacenamiento',
  ...
  business_desc: "Alcance global de servicios, servicio completo",
  business_desc_1: "Agente de transporte de primera clase aprobado por la Comisión Económica y Comercial de China",
  business_desc_2: "Navegante común no tripulado registrado por el Ministerio de Transporte de China (NVOCC-NV00824)",
  business_desc_3: "Empresa registrada en la Comisión de Marítimo Federal de los Estados Unidos",
  business_desc_4: "Certificación del Sistema de Gestión de Salud y Seguridad Ocupacional ISO45001",
  business_desc_5: "Sistema de Gestión de Calidad ISO9001, Sistema de Gestión Ambiental ISO14001",
  business_1: "Logística de Proyectos OOG",
  business_2: "Servicios de Carga General",
  business_3: "Logística de Productos Químicos",
  business_4: "Logística Automotriz",
  business_5: "Logística de Sabiduría",
  business_6: "Asesoría Profesional",

  // BI看板
  bi_title: "Tablero BI",
  bi_desc: "Tablero de Control de Datos",

  // 一带一路 
  one_belt_one_road_title: "Proveedor de Servicios de la Ruta de los Tesoros",
